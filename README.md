...
本地 / 局域网可玩的《Wavelength(心灵波长)》桌游数字版:两队对抗,Psychic 出题,队友拨杆猜目标位置,对方猜左右,先到 10 分获胜。
...
| 默认 | 服务器启动时加载根目录 `cards.json`;无密码无文件时用内置 98 张卡 |
